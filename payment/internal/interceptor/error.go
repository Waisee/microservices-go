...
func UnaryServerInterceptor(logger *slog.Logger) grpc.UnaryServerInterceptor {
	...
	return func(ctx context.Context, req any, info *grpc.UnaryServerInfo, handler grpc.UnaryHandler) (any, error) {
		...
		case errors.Is(err, errs.ErrInvalidOrderUUID):
			return nil, status.Error(codes.InvalidArgument, errs.ErrInvalidOrderUUID.Error())
		case errors.Is(err, errs.ErrInvalidPaymentMethod):
			return nil, status.Error(codes.InvalidArgument, errs.ErrInvalidPaymentMethod.Error())
		}
